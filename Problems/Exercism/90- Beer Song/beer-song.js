...
const reciteGenericVerse = (from) => {
  switch (true) {
    ...
    case from > 2:
      return [
        `${from} bottles of beer on the wall, ${from} bottles of beer.`,
        `Take one down and pass it around, ${from - 1} bottles of beer on the wall.`];
    default: return [];
  }
}
// do the processing using recursion.
