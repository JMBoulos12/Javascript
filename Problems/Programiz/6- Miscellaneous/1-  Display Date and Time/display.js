...
/*
  ...
  In this example, the new Date() constructor is used to create a date object. It gives the date and time according to the given arguments:

  const date = new Date(2017, 2, 12, 9, 25, 30);
  console.log(date); // Sun Mar 12 2017 09:25:30 GMT+0545 (+0545)
  
  Note: The six numbers in new Date() specify year, month, day, hour, minute, second respectively. 
